"""
Flask application factory for DAM.
...
def create_app(config: Config = None) -> Flask:
    ...
    # Initialize database
    from dam.core.database import init_db, get_db
    ...
    app.logger.info(f"DAM application initialized (env: {os.environ.get('DAM_ENV', 'development')})")
