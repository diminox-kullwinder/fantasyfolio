...
def api_system_state():
    ...
    """
    from fantasyfolio.services.volume_monitor import get_all_volume_status
    from fantasyfolio.services.snapshot import get_latest_snapshot, list_snapshots
    from fantasyfolio.services.change_journal import get_journal_stats
    from fantasyfolio.services.backup_policy import get_policy_status
    from fantasyfolio.core.database import get_stats, get_models_stats
...
def api_trash_list():
    ...
    """
    from fantasyfolio.core.database import get_deleted_assets, get_deleted_models
...
def api_trash_asset(asset_id: int):
    ...
    """
    from fantasyfolio.core.database import soft_delete_asset, get_asset_by_id
...
def api_restore_asset(asset_id: int):
    ...
    Returns JSON with success status.
    """
    from fantasyfolio.core.database import restore_asset, get_asset_by_id
...
def api_permanent_delete_asset(asset_id: int):
    ...
    Returns JSON with success status.
    """
    from fantasyfolio.core.database import permanently_delete_asset, get_asset_by_id
...
def api_trash_model(model_id: int):
    ...
    from fantasyfolio.core.database import soft_delete_model, get_model_by_id
...
def api_restore_model(model_id: int):
    ...
    from fantasyfolio.core.database import restore_model, get_model_by_id
...
def api_empty_trash():
    ...
    from fantasyfolio.core.database import empty_trash
...
def api_trash_cleanup():
    ...
    """
    from flask import request
    from fantasyfolio.services.trash_cleanup import cleanup_expired_trash, get_trash_retention_days
...
def api_journal_list():
    ...
    """
    from flask import request
    from fantasyfolio.services.change_journal import get_journal_entries
...
def api_journal_cleanup():
    ...
    """
    from flask import request
    from fantasyfolio.services.change_journal import cleanup_old_entries
...
def api_journal_entity_history(entity_type: str, entity_id: int):
    ...
    from fantasyfolio.services.change_journal import get_entity_history
...
def api_snapshots_list():
    ...
    from fantasyfolio.services.snapshot import list_snapshots
...
def api_snapshots_create():
    ...
    from flask import request
    from fantasyfolio.services.snapshot import create_snapshot
...
def api_snapshots_latest():
    ...
    from fantasyfolio.services.snapshot import get_latest_snapshot
...
def api_snapshots_delete(filename: str):
    """Delete a snapshot."""
    from fantasyfolio.services.snapshot import delete_snapshot
...
def api_snapshots_restore(filename: str):
    ...
    """
    from fantasyfolio.services.snapshot import restore_snapshot
...
def api_snapshots_cleanup():
    ...
    from flask import request
    from fantasyfolio.services.snapshot import cleanup_old_snapshots
...
def api_backup_policies():
    ...
    from fantasyfolio.services.backup_policy import get_all_policies, get_active_policies, get_inactive_policies
...
def api_backup_policy_create():
    ...
    from flask import request
    from fantasyfolio.services.backup_policy import create_policy
...
def api_backup_policy_get(policy_id: str):
    ...
    from fantasyfolio.services.backup_policy import get_policy_by_id
...
def api_backup_policy_update(policy_id: str):
    ...
    from flask import request
    from fantasyfolio.services.backup_policy import update_policy
...
def api_backup_policy_delete(policy_id: str):
    ...
    from fantasyfolio.services.backup_policy import delete_policy
...
def api_backup_policy_run(policy_id: str):
    ...
    from fantasyfolio.services.backup_policy import run_policy_backup
...
def api_backup_policy_validate():
    ...
    from flask import request
    from fantasyfolio.services.backup_policy import validate_policy
...
def api_asset_locations_add():
    ...
    from flask import request
    from fantasyfolio.services.asset_locations import add_location
...
def api_asset_locations_update(location_id: str):
    ...
    from flask import request
    from fantasyfolio.services.asset_locations import update_location
...
def api_asset_locations_delete(location_id: str):
    ...
    from fantasyfolio.services.asset_locations import delete_location
...
def api_asset_locations_test(location_id: str):
    ...
    from fantasyfolio.services.asset_locations import get_location_by_id, test_location
...
def api_asset_locations_remount(location_id: str):
    ...
    from fantasyfolio.services.asset_locations import get_location_by_id, remount_location
...
def api_ssh_key_status():
    """Check if FantasyFolio SSH key exists."""
    from fantasyfolio.services.ssh_keys import check_key_exists
...
def api_ssh_key_generate():
    """Generate a new FantasyFolio SSH key."""
    from fantasyfolio.services.ssh_keys import generate_key
...
def api_ssh_key_delete():
    """Delete the FantasyFolio SSH key."""
    from fantasyfolio.services.ssh_keys import delete_key
...
def api_ssh_test_connection():
    ...
    from flask import request
    from fantasyfolio.services.ssh_keys import test_connection
...
def api_ssh_keys_list():
    ...
    from fantasyfolio.services.ssh_keys import list_system_keys
...
def api_trash_cleanup_status():
    ...
    """
    from flask import request
    from fantasyfolio.services.trash_cleanup import get_expired_trash_items, get_trash_retention_days
...
def api_restic_status():
    ...
    from fantasyfolio.services.restic_backup import check_restic_installed
...
def api_restic_init():
    ...
    """
    from flask import request
    from fantasyfolio.services.restic_backup import init_repo
...
def api_restic_backup():
    ...
    """
    from flask import request
    from fantasyfolio.services.restic_backup import run_backup
    from fantasyfolio.services.snapshot import get_latest_snapshot
...
def api_restic_snapshots():
    ...
    """
    from flask import request
    from fantasyfolio.services.restic_backup import list_snapshots
...
def api_restic_restore():
    ...
    from fantasyfolio.services.restic_backup import restore_database
    ...
    if not db_path:
        from fantasyfolio.core.database import get_database_path
...
def api_restic_stats():
    ...
    """
    from flask import request
    from fantasyfolio.services.restic_backup import get_repo_stats
...
def api_restic_prune():
    ...
    """
    from flask import request
    from fantasyfolio.services.restic_backup import prune_snapshots
